...
# Features
Compared to GitHub Flavored Markdown v0.0.6, MDPreview for Chrome 0.1.0 made the following changes:  
+ Added a Windows registry file md.reg to tell what the MIME type of `.md` file is.
+ Dropped type support for `.mdown` `.markdown` and `text/plain`, added type support for `text/vnd.daringfireball.markdown`
...
3. Open a `.md` file with Chrome locally, or visit any web `.md` resource with one of MIME types `text/markdown` `text/x-markdown` `text/vnd.daringfireball.markdown`.
